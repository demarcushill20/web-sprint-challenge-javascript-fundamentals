...
/*The inner function, nestedFunction, can access the variable internal even though it is declared inside
 the outer function, myFunction. This is because of lexical scoping in JavaScript.
Lexical scoping means that functions are executed using the variable scope chain that was in effect 
when they were defined, not when they are executed. In other words, the inner function has access 
to the variables of its outer functions, including variables declared in the parent function's scope.*/
...
function summation(num) {
  let sum = 0; // Initialize a variable 'sum' to store the summation
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals) {
    const displayNames = []; // Initialize an empty array to store the display names
  
    zooAnimals.forEach((animal) => {
      // Use forEach() to iterate over each animal in the zooAnimals array
      const displayName = `name: ${animal.animal_name}, scientific: ${animal.scientific_name}`;
      // Create a display name string for each animal using string interpolation
      displayNames.push(displayName); // Add the display name to the displayNames array
    });
  
    return displayNames; // Return the array of display names
  }
  ...
  */
  ...
  function lowerCaseNames(zooAnimals) {
    ...
    // Use map() to create a new array with the animal names converted to lowercase
  
    return lowerCaseNames; // Return the new array
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals) {
    ...
    // Use filter() to create a new array of objects containing only animals with a population of less than 5
  
    return lowPopulationAnimals; // Return the new array
  }
  ...
  */
  ...
  function USApop(zooAnimals) {
    ...
    // Use reduce() to find the total population from the zooAnimals array
  ...
  */
    ...
    function consume(a, b, cb) {
      return cb(a, b); // Invoke the callback function (cb) with arguments a and b, and return the result
    }
...
function greeting(firstName, lastName) {
  return `Hello ${firstName} ${lastName}, nice to meet you!`; // Return a formatted greeting string
}
...
function CuboidMaker(options) {
  this.length = options.length; // Initialize the 'length' property with the value from the options object
  this.width = options.width; // Initialize the 'width' property with the value from the options object
  this.height = options.height; // Initialize the 'height' property with the value from the options object
}
...
CuboidMaker.prototype.volume = function() {
  return this.length * this.width * this.height; // Calculate and return the volume of the cuboid
};
...
CuboidMaker.prototype.surfaceArea = function() {
  ...
  // Calculate and return the surface area of the cuboid
};
